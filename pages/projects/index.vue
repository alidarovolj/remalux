...
<template>
  ...
  <div class="py-0 md:py-16">
    <div v-if="projectsList" class="container mx-auto px-4 lg:px-0">
      <h1
        class="text-xl md:text-3xl font-medium mb-0 md:mb-5 text-mainColor font-montserrat"
      >
        {{ t("projects.title") }}
      </h1>
      <div class="flex flex-col gap-10">
        <div
          ...
          :class="[
            {
              'flex-col md:!flex-row-reverse text-check':
                carouselIndex % 2 === 1,
            },
        ...
        >
            ...
            <client-only>
              ...
              >
                <my-carousel-slide
                  ...
                  :key="index"
                  class="w-full h-[200px] md:h-[350px] relative"
                >
                  <img
                    :src="item"
                    alt=""
          ...
          <div class="px-0 md:px-5 p-5 md:p-14">
            <h2
              class="text-lg md:text-3xl font-medium text-mainColor mb-4 font-montserrat"
            >
              {{ project.title[cur_lang] }}
            </h2>
            <p
              class="text-sm md:text-lg text-gray-500 mb-0 md:mb-8"
