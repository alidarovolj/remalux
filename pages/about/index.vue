...
<template>
  <div class="bg-white pb-32">
    <main class="isolate">
      <!-- Hero section -->
      <div
        class="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-mainColor/20 pt-14"
      >
        <div
          aria-hidden="true"
          class="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white shadow-xl shadow-mainColor/10 ring-1 ring-mainColor sm:-mr-80 lg:-mr-96"
        />
        <div class="mx-auto max-w-7xl px-6 py-10 sm:py-40 lg:px-8">
          <div
          ...
          >
            <h1
              class="max-w-2xl text-xl md:text-4xl font-bold tracking-tight text-gray-900 lg:col-span-2 xl:col-auto font-montserrat"
              data-aos="fade-up"
            >
            ...
            >
              <p
                class="text-sm md:text-base leading-5 md:leading-8 text-gray-600"
              >
                {{ t("about_page.hero_section.description") }}
              </p>
            </div>
            <div
              class="relative mt-10 aspect-[6/5] w-full rounded-2xl object-cover sm:mt-16 lg:mt-0 lg:max-w-none xl:row-span-2 xl:row-end-2 xl:mt-36"
              data-aos="fade-up"
            >
              <img
                alt=""
              ...
              />
              <div
                class="bg-mainColor absolute -right-4 md:-right-9 top-4 md:top-9 rounded-2xl w-full h-3/4"
              ></div>
            </div>
          </div>
        </div>
      ...
      <!-- Content section -->
      <div class="mt-32 overflow-hidden sm:mt-40" data-aos="fade-up">
        <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
          ...
          >
            <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
              <h2
                class="text-lg md:text-3xl font-bold tracking-tight text-gray-900 font-montserrat"
              >
                {{ t("about_page.for_whom.title") }}
              </h2>
              <p
                class="mt-6 text-sm md:text-xl leading-5 md:leading-8 text-gray-600"
              >
                {{ t("about_page.for_whom.description") }}
              </p>
            </div>
            <div
              ...
              >
                ...
                >
                  <img
                    ...
                    data-aos="fade-up"
                    src="@/assets/img/about/about-4.png"
                  />
                </div>
              </div>
            </div>
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div
          class="mx-auto flex w-full flex-col items-end justify-between gap-5 lg:mx-0 lg:max-w-none lg:flex-row"
        >
          <div class="w-full lg:flex-auto">
            <h2
              class="text-lg md:text-3xl font-montserrat font-bold tracking-tight text-gray-900"
              data-aos="fade-up"
            >
              <span class="text-mainColor">{{
                t("about_page.remalux_section.title")
              }}</span>
            </h2>
            <img
              alt=""
              class="mt-16 mb-5 aspect-[6/5] w-full rounded-2xl bg-gray-50 object-cover lg:aspect-auto lg:h-[34.5rem]"
              data-aos="fade-up"
              src="https://images.unsplash.com/photo-1606857521015-7f9fcf423740?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1344&h=1104&q=80"
            />
            <p
              class="text-sm md:text-base text-[#7B7B7B] leading-5 md:leading-8"
              data-aos="fade-up"
            >
              {{ t("about_page.remalux_section.description") }}
            </p>
          </div>
          <div class="w-full lg:flex-auto">
            <ul class="flex flex-col gap-5">
              <li
                ...
                data-aos="fade-up"
              >
                <p class="text-mainColor font-montserrat font-extrabold mb-3">
                  {{ t("about_page.remalux_section.innovation.title") }}
                </p>
                <p class="text-sm md:text-base">
                  {{ t("about_page.remalux_section.innovation.description") }}
                </p>
              </li>
              <li
                class="gap-3 border-b border-[#F0DFDF] pb-7"
              ...
              >
                <p class="text-mainColor font-montserrat font-extrabold mb-3">
                  {{ t("about_page.remalux_section.service.title") }}
                </p>
                <p class="text-sm md:text-base">
                  {{ t("about_page.remalux_section.service.description") }}
                </p>
              </li>
              <li
                class="gap-3 border-b border-[#F0DFDF] pb-7"
              ...
              >
                <p class="text-mainColor font-montserrat font-extrabold mb-3">
                  {{ t("about_page.remalux_section.assortment.title") }}
                </p>
                <p class="text-sm md:text-base">
                  {{ t("about_page.remalux_section.assortment.description") }}
                </p>
              </li>
              <li
                class="gap-3 border-b border-[#F0DFDF] pb-7"
              ...
              >
                <p class="text-mainColor font-montserrat font-extrabold mb-3">
                  {{ t("about_page.remalux_section.safety.title") }}
                </p>
                <p class="text-sm md:text-base">
                  {{ t("about_page.remalux_section.safety.description") }}
                </p>
              </li>
            </ul>
          </div>
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <h2
          class="text-lg md:text-3xl font-montserrat font-bold tracking-tight text-mainColor mb-5"
          data-aos="fade-up"
        >
        ...
        <p class="text-sm md:text-base" data-aos="fade-up">
