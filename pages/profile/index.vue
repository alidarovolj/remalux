      ...
      <div class="flex flex-col gap-4">
        <div class="bg-white p-4 md:p-6 rounded-2xl set_shadow">
          ...
          >
            <img
              alt=""
              class="w-[70px] md:w-[100px] h-[70px] md:h-[100px] rounded-full object-cover"
          ...
          <div class="flex flex-col gap-4">
            <div class="flex items-center">
              <p class="w-1/2 md:w-1/6 text-sm md:text-lg text-[#7B7B7B]">
                {{ $t("profile.phone") }}:
              </p>
              <p class="text-sm md:text-base" v-if="user.userProfile">
        ...
        <div class="bg-white p-4 md:p-6 rounded-2xl set_shadow">
          <div class="flex justify-between items-center mb-4">
            ...
            <NuxtLink
              ...
              class="text-xs md:text-base text-[#2157E2]"
            >
