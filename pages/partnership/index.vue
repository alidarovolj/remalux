    ...
    <main class="isolate">
      ...
      <div class="relative isolate -z-10">
        ...
        <div class="overflow-hidden container mx-auto px-4 md:px-0">
          <div class="mx-auto pb-32 pt-36 sm:pt-60 lg:pt-32">
            <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1
                    data-aos="fade-up"
                    class="text-4xl font-medium font-montserrat tracking-tight text-gray-900 sm:text-[40px]"
                >
                  {{ t("partnership.title") }}
                </h1>
                <p
                    data-aos="fade-up"
                    class="relative my-6 text-xl font-light leading-8 text-gray-600 sm:max-w-md lg:max-w-none"
                >
              ...
              >
                ...
                <div class="w-44 flex-none space-y-8 pt-32 sm:pt-0" data-aos="fade-up">
                  <div class="relative">
                    <img
      ...
      <div class="text-center w-full md:w-1/2 mx-auto">
        <h3
            data-aos="fade-up"
            class="text-2xl mb-3 font-semibold font-montserrat text-mainColor"
        >
          {{ t("partnership.history_title") }}
        </h3>
        <p data-aos="fade-up" class="leading-6 mb-10">
            ...
            <div class="relative text-gray-700 antialiased text-sm font-semibold">
              ...
              <div class="mt-6 sm:mt-0 sm:mb-12">
                <div class="flex flex-col sm:flex-row items-start">
                  <div class="flex justify-start w-full mx-auto items-center text-right">
              ...
              <div class="mt-6 sm:mt-0 sm:mb-12">
                <div class="flex flex-col sm:flex-row items-start">
                  <div class="flex justify-end w-full mx-auto items-center text-left">
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8 mb-32" data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 gap-y-5 sm:grid-cols-2 sm:gap-x-5 md:grid-cols-3">
          <div class="flex items-start gap-5" data-aos="fade-up">
            <div class="flex-none w-12 h-12 bg-mainColor rounded flex items-center justify-center text-white">
      ...
      <div class="container mx-auto px-4 md:px-0 mb-48">
        <p class="mb-9 text-4xl font-medium">
        ...
        <div class="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-4 sm:gap-y-5 xl:grid-cols-3">
          <div
              data-aos="fade-up"
              class="w-full flex"
              style="box-shadow: 0px 0px 20px 0px #0000000D"
          >
            <div class="bg-[#F4EDE7] rounded-l w-full flex items-end p-5">
              <div>
                <p class="text-2xl font-medium mb-3 font-montserrat">
                  {{ t("partnership.product_paint") }}
                </p>
                <p class="text-xs">{{ t("partnership.product_paint_description") }}</p>
              </div>
            </div>
            <img class="w-full" src="@/assets/img/partnership/products/1.png" alt=""/>
          </div>
          <div
              data-aos="fade-up"
              class="w-full flex"
              style="box-shadow: 0px 0px 20px 0px #0000000D"
          >
            <div class="bg-[#FDCDBF] rounded-l w-full flex items-end p-5">
              <div>
                <p class="text-2xl font-medium mb-3 font-montserrat">
                  {{ t("partnership.product_varnish") }}
                </p>
                <p class="text-xs">{{ t("partnership.product_varnish_description") }}</p>
              </div>
            </div>
            <img class="w-full" src="@/assets/img/partnership/products/1.png" alt=""/>
          </div>
          <div
              ...
              style="box-shadow: 0px 0px 20px 0px #0000000D"
          >
            <div class="bg-[#DAE4A7] rounded-l w-full flex items-end p-5">
              <div>
                <p class="text-2xl font-medium mb-3 font-montserrat">
                  {{ t("partnership.product_putty") }}
                </p>
                <p class="text-xs">{{ t("partnership.product_putty_description") }}</p>
              </div>
            </div>
            <img class="w-full" src="@/assets/img/partnership/products/1.png" alt=""/>
          </div>
          ...
          >
            <div class="bg-[#FDCDBF] rounded-l w-full flex items-end p-5">
              <div>
                ...
                <p class="text-xs">{{ t("partnership.product_coating_description") }}</p>
              </div>
            </div>
            <img class="w-full" src="@/assets/img/partnership/products/1.png" alt=""/>
          </div>
          ...
          >
            <div class="bg-[#DAE4A7] rounded-l w-full flex items-end p-5">
              <div>
                ...
                <p class="text-xs">{{ t("partnership.product_enamel_description") }}</p>
              </div>
            </div>
            <img class="w-full" src="@/assets/img/partnership/products/1.png" alt=""/>
          </div>
          ...
          >
            <div class="bg-[#F4EDE7] rounded-l w-full flex items-end p-5">
              <div>
                ...
                <p class="text-xs">{{ t("partnership.product_glue_description") }}</p>
              </div>
            </div>
            <img class="w-full" src="@/assets/img/partnership/products/1.png" alt=""/>
          </div>
      ...
      <div class="container mx-auto px-4 md:px-0 mb-24">
        ...
        >
          <div data-aos="fade-right" class="relative w-full md:w-1/3">
            <img class="w-full" src="@/assets/img/partnership/phones.png" alt=""/>
          </div>
          <div data-aos="fade-left" class="w-full md:w-2/3">
            <p class="text-2xl md:text-3xl font-medium font-montserrat mb-3">
            ...
            <div class="flex items-center gap-3">
              ...
              <a href="https://instagram.kz" class="text-xl font-montserrat font-medium">
                @remalux.kz
              </a>
            </div>
          </div>
      ...
      <div
        ...
        >
          <div data-aos="fade-right" class="w-full">
            <p class="text-mainColor text-3xl font-medium font-montserrat mb-4">
