  ...
  <div class="pt-12 pb-32">
    ...
    >
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h1
          class="text-xl md:text-3xl font-bold tracking-tight text-gray-900 font-montserrat"
        >
          {{ $t("contacts.title") }}
        </h1>
      </div>
      <div class="mx-auto mt-6 mb-12 flex flex-col md:flex-row gap-5">
        <div
          v-for="(item, index) of contactsList.data"
          :key="index"
          :class="{
            '!border-mainColor !text-black bg-[#F0DFDF] border-l-[6px]':
      ...
      <div class="flex flex-col md:flex-row gap-5">
        <div class="w-full md:w-1/2">
          <p
            class="text-xl md:text-2xl font-montserrat font-semibold mb-6"
            data-aos="fade-up"
          >
          ...
          <div class="flex flex-col gap-5">
            ...
            >
              ...
              <p class="w-3/4 ml-2 font-semibold">
        ...
        <div v-if="activeContact" class="w-full md:w-1/2">
          <client-only>
            <MapsYandexMapsWithPlacemarks
              :location="{
