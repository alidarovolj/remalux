    ...
    <div class="bg-white text-sm cursor-pointer mt-5">
      <div class="flex items-center gap-6 mb-4">
        <div class="flex gap-2 items-center">
          <p class="text-3xl font-medium whitespace-nowrap">{{ colorCookie.title[cur_lang] }}</p>
        </div>
        ...
        <div class="flex flex-col gap-9 w-full">
          ...
          <div class="bg-[#F0DFDF] rounded-xl flex items-center gap-6 element_hover">
            ...
            <div class="flex items-center justify-between">
              <p class="text-2xl text-mainColor">{{ $t('colors_modal.second') }}</p>
              <ChevronRightIcon class="text-mainColor w-20 h-20"/>
            </div>
          </div>
        </div>
      </div>
