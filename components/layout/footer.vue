...
const navigation = computed(() => {
  return {
    about: [
      {name: t('footer_links.remalux.about_us'), href: '/'},
      {name: t('footer_links.remalux.projects'), href: '/'},
      {name: t('footer_links.remalux.news'), href: '/'},
      {name: t('footer_links.remalux.contacts'), href: '/'},
    ],
    store: [
      {name: t('footer_links.store.products'), href: '/'},
      {name: t('footer_links.store.payment_and_delivery'), href: '/'},
      {name: t('footer_links.store.calculator'), href: '/'},
      {name: t('footer_links.store.choose_color'), href: '/'},
      {name: t('footer_links.store.public_offer'), href: '/'},
    ],
    social: [
      {
        name: 'Facebook',
